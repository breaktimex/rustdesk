...
List<CustomShortcut> _defaultCustomShortcuts() {
  ...
  return [
    ...
    CustomShortcut(label: 'Shift', key: 'RShift'),
...
List<CustomShortcut> _defaultCustomShortcuts2() {
  return [
    ...
    CustomShortcut(label: '-',     key: 'VK_MINUS'),
    CustomShortcut(label: '=',     key: 'VK_PLUS'),
    CustomShortcut(label: '[',     key: 'VK_LBRACKET'),
    CustomShortcut(label: ']',     key: 'VK_RBRACKET'),
    CustomShortcut(label: '\\',   key: 'VK_BACKSLASH'),
    CustomShortcut(label: ';',     key: 'VK_SEMICOLON'),
    // Row 2: More symbols + lock keys
    CustomShortcut(label: '\'',   key: 'VK_QUOTE'),
    CustomShortcut(label: '`',     key: '`'),
    CustomShortcut(label: ',',     key: 'VK_COMMA'),
    CustomShortcut(label: '.',     key: '.'),
    CustomShortcut(label: '/',     key: 'VK_SLASH'),
    ...
    CustomShortcut(label: 'Apps',  key: 'Apps'),
    CustomShortcut(label: 'Win',   key: 'Meta'),
    CustomShortcut(label: 'Shift', key: 'RShift'),
    CustomShortcut(label: '',      key: ''),
    CustomShortcut(label: '',      key: ''),
    CustomShortcut(label: '',      key: ''),
